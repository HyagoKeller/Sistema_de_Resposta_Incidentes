...
export default function LoginPage() {
  ...
  return (
    <div className="relative flex min-h-screen flex-col gov-deep text-primary-foreground">
      ...
      <div className="relative z-10 mx-auto grid w-full max-w-6xl flex-1 items-center gap-10 px-5 py-14 lg:grid-cols-2 lg:gap-16">
        ...
        <section className="text-center lg:text-left">
          ...
          <p className="mt-3 max-w-md text-sm leading-relaxed text-primary-foreground/75 mx-auto lg:mx-0">
